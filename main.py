...
st.sidebar.subheader('Fixed Term')
Fixed_term = st.sidebar.number_input(label=f'Fixed Term (years):',value=2, step=2)
st.sidebar.subheader('Variable Interest Rate')
Variable_interest_rate_text = st.sidebar.number_input(label=f'Variable Interest Rate (%)):',value=3.74, step=1)
